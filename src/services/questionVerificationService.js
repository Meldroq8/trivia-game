...
المطلوب:
1. تحقق من القواعد والإملاء
2. ابحث في الإنترنت: هل الإجابة صحيحة للسؤال؟

⚠️ قواعد مهمة للتحقق:
- إذا الإجابة صحيحة أو صحيحة جزئياً = factualAccuracy: "verified"
- فقط إذا الإجابة خاطئة 100% بشكل مؤكد = factualAccuracy: "incorrect"
- لأسئلة الأفلام/المسلسلات/الفن: كن متساهلاً، قد لا تجد معلومات دقيقة
- إذا لم تجد معلومات كافية للتأكد = اعتبرها "verified" (الشك لصالح السؤال)

⚠️ فقط إذا كانت الإجابة خاطئة 100%، اكتب سؤالاً بديلاً في suggestedQuestion
مثال: السؤال "أغلى معدن؟" والإجابة "الذهب" خاطئة 100%
suggestedQuestion: "ما أشهر معدن ثمين في المجوهرات؟"
...
أجب JSON فقط:
{
  ...
  "suggestedQuestion": "فقط إذا خاطئة 100%",
  "notes": "سبب قصير",
  "sources": []
}`
