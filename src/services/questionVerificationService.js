...
⚠️ مهم جداً جداً: إذا كانت الإجابة خاطئة، يجب أن تكتب سؤالاً بديلاً في suggestedQuestion
مثال: السؤال "أغلى معدن؟" والإجابة "الذهب" خاطئة
suggestedQuestion يجب أن يكون: "ما أشهر معدن ثمين في المجوهرات؟"
...
أجب JSON فقط:
{
  ...
  "suggestedQuestion": "اكتب سؤال بديل هنا إذا الإجابة خاطئة - لا تتركه فارغاً!",
  "notes": "سبب قصير",
  "sources": []
}`
