      ...
      <div className="bg-red-600 text-white p-2 md:p-3 flex-shrink-0 sticky top-0 z-10">
        <div className="flex justify-between items-center">
          <div className="flex flex-col md:flex-row md:items-center md:gap-3">
            ...
            <span className="text-sm md:text-lg text-white/80 hidden md:inline">Choose 6 Categories</span>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3 md:gap-4 w-full max-w-7xl flex-1 content-start">
          {isLoading ? (
            ...
            Array.from({ length: 12 }).map((_, index) => (
              <div
                key={`skeleton-${index}`}
                className="relative p-0 rounded-lg min-h-[100px] md:min-h-[120px] flex flex-col border-2 border-gray-200 bg-gray-50 animate-pulse"
              >
            ...
            return (
              <button
                ...
                disabled={!canSelect}
                className={`
                  relative p-0 rounded-lg font-bold text-sm md:text-xl transition-all duration-200 transform hover:scale-105 overflow-hidden border-2 min-h-[100px] md:min-h-[120px] flex flex-col
                  ${selected
